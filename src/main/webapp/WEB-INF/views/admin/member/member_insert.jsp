          ...
          <form name="form_write" action="/admin/member/member_insert" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input value="" name="user_pw" type="password" class="form-control" id="user_pw" placeholder="암호를 입력해주세요" required>
              </div>
              <div class="form-group">
...
$(document).ready(function(){
	...
	$("#btn_id_check").click(function(){
		...
		$.ajax({
			...
			url:"/id_check?user_id="+user_id,//RestAPI서버(스프링클래스로 제작)
			dataType:"text",//결과값을 받을때, 데이터형을 text,json,xml중 선택
