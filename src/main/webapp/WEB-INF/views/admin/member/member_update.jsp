          ...
          <form name="form_write" action="/admin/member/member_update" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
             <div class="form-group">
              <img style="width:120px;height:120px;border-radius: 70%;" onerror="this.src='/resources/admin/dist/img/default-150x150.png'" src="/resources/profile/${memberVO.user_id}.jpg">
              </div>
               ...
               <div class="form-group">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="file0">파일선택(jpg)</label> 
                  </div>
                </div>
              </div>
              <div class="form-group">
...
$(document).ready(function(){
	...
	$("#btn_list").click(function(){
		/*폼을 get방식을 전송시 암호롸 같은 정보가 URL쿼리 스트링에 노출되어서 주석처리
