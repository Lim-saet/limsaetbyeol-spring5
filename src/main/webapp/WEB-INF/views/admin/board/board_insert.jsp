          ...
          <form name="form_write" method="post" action="/admin/board/board_insert" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input value="" name="title" type="text" class="form-control" id="title" placeholder="제목을 입력해주세요" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input value="" name="writer" type="text" class="form-control" id="writer" placeholder="작성자를 입력해주세요" required>
              </div>
              <div class="form-group">
                ...
                <!-- 위 div_file_delete 영역이름은 첨부파일을 개별 Ajax 삭제할때 필요 -->
                  <div class="custom-file">
                    <input name= "file" type="file" class="custom-file-input" id="file_${idx}"><!-- id는 식별자 -->
            ...
            <div class="card-footer text-right">
              ...
              <a href="/admin/board/board_list?bno=&page=${pageVO.page}&search_type=${pageVO.search_type}" class="btn btn-info">목록</a>
            </div>
...
<script>
	$(document).ready(function(){
		// $('#content_lbl').summernote();//기본실행. 이 기본실행을 개발자가 커스터마이징 함
		// 형식이 똑같음 => $.ajax({});
