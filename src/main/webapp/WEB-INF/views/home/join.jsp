			...
			<fieldset>
				...
				<ul class="app_list">
					...
					<li class="clear">
						...
						<div class="app_content"><input readonly type="digits" name="point" class="w100p" id="point_lbl" placeholder="이메일을 입력해주세요" required/></div>
					</li>
					<li class="clear">
						<label for="gender_lbl" class="tit_lbl pilsoo_item">로그인여부</label>
						<div class="app_content">
							<input checked type="radio" name="enabled" class="css-radio" id="woman_lbl" />
