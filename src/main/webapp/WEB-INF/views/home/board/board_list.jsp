    ...
    <div id="container">
		...
		<div class="bodytext_area box_inner">
			...
			<table class="bbsListTbl" summary="번호,제목,조회수,작성일 등을 제공하는 표">
				...
				<tr>
						<td>
						<!-- 전체게시물개수-(현재페이지x1페이지당 보여줄 개수)+1페이지당 보여줄 개수-현재인덱스(위부터 0) -->
			...
			<div class="pagination justify-content-center">
				...
				<a href="/home/boar/board_list?page=${pageVO.startPage-1}&search_type=${pageVO.search_type}" class="prevpage pbtn ${disabled}">
				...
				<a href="/home/boar/board_list?page=${pageVO.endPage+1}&search_type=${pageVO.search_type}" class="nextpage pbtn ${disabled}">
