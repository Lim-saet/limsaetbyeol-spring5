...
/**
 * 이 클래슷 sqlSession 템플릿을 이용해서 쿼리를 실행하는 클래스입니다
 * @author 임샛별
 *
 */
@Repository
public class ReplyDAOImpl implements IF_ReplyDAO{
	@Inject //자바8부터 지원됌, 이전@Autowired, @Resource 스프링빈을 주입
	...
	public void updateReply(ReplyVO replyVO) throws Exception {
		...
		sqlSession.update("replyMapper.update",replyVO);
	}

	@Override
	public void replyCountUpdate(Integer bno, int count) throws Exception {
		// TODO 매개변수가 두개일때 처리 1개 오브젝트인 Map데이터형태로 담아보냄
	...
	public List<ReplyVO> selectReply(PageVO pageVO) throws Exception {
		// TODO sqlSession 템플릿 사용("매퍼쿼리명","매개변수명")
