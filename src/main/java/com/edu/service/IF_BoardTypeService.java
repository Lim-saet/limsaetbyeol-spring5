 ...
 * 그러면, DAO와 똑같으나 나중에 DAO10개일때-> 서비스는 5개로 처리 가능하게되는 경우가 있어서 ..
 * 스프링부트는 위 과정이 1개로 합쳐져있어서 상대적으로 간단한 프로젝트에 부트를 사용
 * @author 임샛별
 *
 */
public interface IF_BoardTypeService {
	//CRUD 메서드 명세만 생성(아래5개)
		...
		//BoardTypeVO 1개의 레코드를 저장한 클래스를 다중레코드 List<>형 묶어서 받습니다
